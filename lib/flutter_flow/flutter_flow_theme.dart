...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF730202);
  late Color secondary = const Color(0xFFEE2E29);
  late Color tertiary = const Color(0xFF611427);
  late Color alternate = const Color(0xFFE3E7ED);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF7B7B7B);
  late Color primaryBackground = const Color(0xFF17171A);
  late Color secondaryBackground = const Color(0xFF121214);
  late Color accent1 = const Color(0x4D730202);
  late Color accent2 = const Color(0x4CEE2E29);
  late Color accent3 = const Color(0x4C611427);
