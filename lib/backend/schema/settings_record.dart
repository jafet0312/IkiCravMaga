...
class SettingsRecord extends FirestoreRecord {
  ...
  // "title" field.
  int? _title;
  int get title => _title ?? 0;
  bool hasTitle() => _title != null;

  void _initializeFields() {
    _name = snapshotData['name'] as String?;
    _title = castToType<int>(snapshotData['title']);
  }
...
class SettingsRecordDocumentEquality implements Equality<SettingsRecord> {
  ...
  bool equals(SettingsRecord? e1, SettingsRecord? e2) {
    return e1?.name == e2?.name && e1?.title == e2?.title;
  }

  @override
  int hash(SettingsRecord? e) => const ListEquality().hash([e?.name, e?.title]);
