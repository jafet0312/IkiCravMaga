                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.txtfFechaTextController,
                                          focusNode: _model.txtfFechaFocusNode,
                                          autofocus: false,
                                          readOnly: true,
                                          obscureText: false,
                                          ...
                                          validator: _model
                                              .txtfFechaTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                ...
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.txtFDescripcionFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'tjweg63j' /* Descripción */,
                                        ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      highlightColor: Colors.transparent,
                                      onTap: () async {
                                        _model.validacionFormularioCopy = true;
                                        if (_model.formKey.currentState ==
                                                null ||
                                            !_model.formKey.currentState!
                                                .validate()) {
                                          setState(() =>
                                              _model.validacionFormularioCopy =
                                                  false);
                                          return;
                                        }
