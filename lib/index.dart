// Export pages
export '/paginas_principales/home_page/home_page_widget.dart'
    show HomePageWidget;
export '/paginas_principales/login/login_widget.dart' show LoginWidget;
export '/paginas_secundarias/registro/registro_widget.dart' show RegistroWidget;
...
export '/paginas_secundarias/sugerencias/sugerencias_widget.dart'
    show SugerenciasWidget;
export '/paginas_secundarias/guias/guias_widget.dart' show GuiasWidget;
